#!/usr/bin/env python3
# This script will add the medicines page to admin_dashboard.py

import os

# Read the file
file_path = r'E:\Integrated_Patient_Care_Management_System\pages\admin_dashboard.py'

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# The new medicines section to insert
medicines_section = '''
    # PAGE: MEDICINES
    elif page == "medicines":
...
# Insert before "elif page == "ai_care":"
target = '    elif page == "ai_care":'
if target in content:
    content = content.replace(target, medicines_section + target)
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(content)
    print("SUCCESS: Medicines page added to admin dashboard!")
else:
    print("ERROR: Could not find target in file")
